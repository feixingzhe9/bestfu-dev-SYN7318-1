...
//硬件看门狗端口
#define EXTERNAL_WDG_EN				1 //1：开启硬件看门狗。0：不产生硬件喂狗
#if EXTERNAL_WDG_EN
...
#define CHANNEL_1M         (1)
#define CHANNEL_10M        (10)
#define SI4432_CHANNELPACE (0) //定义433通信的信道种类
#if (SI4432_CHANNELPACE != CHANNEL_1M && SI4432_CHANNELPACE != CHANNEL_10M)
	#undef SI4432_CHANNELPACE
#endif
